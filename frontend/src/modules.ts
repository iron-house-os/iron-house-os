...
export const modules: AppModule[] = [
  ...
  },
  {
    ...
    icon: HardHat,
    description: "Time, journal, safety, photos, requests, employee contacts, and ticket expiries.",
    status: "Active",
  },
  {
  ...
  },
  {
    ...
    icon: Truck,
    description: "Fuel, kilometres, maintenance, receipts and service dates for company vehicles.",
    status: "Build 220 active",
  },
  {
    ...
    path: "/safety-program",
    icon: ShieldCheck,
    description: "Controlled safety manual, SWPs, field records, competency and safety intelligence.",
