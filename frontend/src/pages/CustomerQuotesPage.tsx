        ...
        <div className="space-y-3">
          ...
          {lineItems.map((line, index) => (
            <div key={index} className="grid gap-3 rounded-md border border-iron-100 p-3 md:grid-cols-[1fr_100px_100px_140px_44px]">
              ...
              <Field label="Quantity" type="number" value={line.quantity} onChange={(value) => setLine(index, { quantity: value })} required />
              <Field label="Unit" value={line.unit} onChange={(value) => setLine(index, { unit: value })} required />
              <Field label="Unit price" type="number" value={line.unit_price} onChange={(value) => setLine(index, { unit_price: value })} required />
