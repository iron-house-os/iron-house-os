...
const formTypes = ["Toolbox Talk", "Equipment Inspection", "Incident / Near Miss", "Corrective Action", "Ground Disturbance Permit", "Confined Space Permit", "First Aid Record"];
