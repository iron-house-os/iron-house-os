...
from app.schemas.backups import BackupsIntakeList
...
def backups_review_queue(db: DBSession, user: CurrentUser) -> BackupsIntakeList:
    return backups.list_finance_review_queue(db, user)
